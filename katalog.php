...
<body>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <form class="form-inline my-2 my-lg-0" style="margin-left: 300px;" action="" method="POST">
                <input class="form-control mr-sm-2" name="inputCari" type="search" placeholder="Ketikkan Nama Barang" aria-label="Search" style="width: 60%;">
                ...
                ?>
                        <div class="col-lg-3" data-aos="fade-up" data-aos-duration="300">
                            <div class="kotak-item" id="gambar1">
                                ...
                                <button class="btn btn-info" data-toggle="modal" data-target="#Modal<?php echo $data['nama_barang']; ?>">Lihat</button>
                                <a href="sewa.php?nama_barang=<?php echo $data['nama_barang']; ?>&harga=<?php echo $data['harga']; ?>" class="btn btn-danger">Sewa</a>
                            </div>
                        </div>
                        <!-- Modal -->
